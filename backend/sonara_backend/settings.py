...
if ENV == 'dev':
    SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY','0j9sg&u-z4a5u2sge!_j9hgbow^3b5h6sj&i-h9b5mx-v2odj+')
else:
...
ROOT_URLCONF = 'sonara_backend.urls'
...
WSGI_APPLICATION = 'sonara_backend.wsgi.application'
