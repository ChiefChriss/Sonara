...
from .views import (
    ...
    # ── NEW: Marketplace ──
    PurchaseTrackView, PurchasePublicationView, MyPurchasesView,
    MarketplaceView, SellerRevenueView,
)
...
urlpatterns = [
    ...
    path('publications/<int:pk>/purchase/', PurchasePublicationView.as_view(), name='publication-purchase'),
